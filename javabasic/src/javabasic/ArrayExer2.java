...
public class ArrayExer2 {
	...
	public static void main(String[] args) {
		...
		System.out.printf("\n%5s %5s %5s %5s","이름", "국어", "영어","수학");
		int nameArrLeng = nameArr.length;
		int scorArrLeng = scoreArr.length;
		for (int i =0; i<nameArrLeng; i++) {
			System.out.printf("\n%5s", nameArr[i]);
			for(int j=0; j<scorArrLeng; j++)
				System.out.printf("%5d",scoreArr[i][j]);
		}
